...
SPECS: Tuple[WorksheetSpec, ...] = (
    WorksheetSpec('ages 5-6', (
        (1, ExerciseTemplate(Operation.addition, InRange(0, 50), InRange(0, 50), NoConstraint())),
        (1, ExerciseTemplate(Operation.subtraction, InRange(0, 50), InRange(0, 25), InRange(0, 50))),
        (0.4, ExerciseTemplate(Operation.addition, MultipleOf(10, InRange(0, 20)), MultipleOf(10, InRange(0, 20)), NoConstraint())),
        (0.4, ExerciseTemplate(
